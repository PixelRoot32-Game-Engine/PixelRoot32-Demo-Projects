...
// 22050 Hz, 1024-sample buffer. The buffer length is the floor on how late a
// scheduled step can be heard: the scheduler's resolution is the frame, but
// the backend's is the block.
...
sfx_bank::SfxBankScene sfxBankScene;
